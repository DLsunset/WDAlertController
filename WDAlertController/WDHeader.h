...
#define WD_SafeAreaTopBar ([[UIApplication sharedApplication] statusBarFrame].size.height > 20 ? 24 : 0)
...
#define WD_font_Regular(size) [UIFont fontWithName:@"PingFangSC-Regular" size:(size)]
#define WD_font_Semibold(size) [UIFont fontWithName:@"PingFangSC-Semibold" size:(size)]
#define WD_font_Medium(size) [UIFont fontWithName:@"PingFangSC-Medium" size:(size)]
